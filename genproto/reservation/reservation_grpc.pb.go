...
const (
	...
	Reservation_GetReservationByID_FullMethodName  = "/reservation.Reservation/GetReservationByID"
	Reservation_UpdateReservation_FullMethodName   = "/reservation.Reservation/UpdateReservation"
	Reservation_DeleteReservation_FullMethodName   = "/reservation.Reservation/DeleteReservation"
	Reservation_ValidateReservation_FullMethodName = "/reservation.Reservation/ValidateReservation"
	Reservation_Order_FullMethodName               = "/reservation.Reservation/Order"
	Reservation_Pay_FullMethodName                 = "/reservation.Reservation/Pay"
	Reservation_FetchReservations_FullMethodName   = "/reservation.Reservation/FetchReservations"
)
...
func (c *reservationClient) GetReservationByID(ctx context.Context, in *ID, opts ...grpc.CallOption) (*ReservationInfo, error) {
	...
	err := c.cc.Invoke(ctx, Reservation_GetReservationByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) UpdateReservation(ctx context.Context, in *ReservationInfo, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, Reservation_UpdateReservation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) DeleteReservation(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, Reservation_DeleteReservation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) ValidateReservation(ctx context.Context, in *ReservationDetails, opts ...grpc.CallOption) (*ID, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ID)
	err := c.cc.Invoke(ctx, Reservation_ValidateReservation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) Order(ctx context.Context, in *ReservationOrders, opts ...grpc.CallOption) (*ID, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ID)
	err := c.cc.Invoke(ctx, Reservation_Order_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) Pay(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
	err := c.cc.Invoke(ctx, Reservation_Pay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) FetchReservations(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*Reservations, error) {
	...
	err := c.cc.Invoke(ctx, Reservation_FetchReservations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reservation_ValidateReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_ValidateReservation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Reservation_Order_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_Order_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Reservation_Pay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_Pay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Reservation_FetchReservations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_FetchReservations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
