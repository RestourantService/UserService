...
const (
	Menu_AddMeal_FullMethodName     = "/menu.Menu/AddMeal"
	Menu_GetMealByID_FullMethodName = "/menu.Menu/GetMealByID"
	Menu_UpdateMeal_FullMethodName  = "/menu.Menu/UpdateMeal"
	Menu_DeleteMeal_FullMethodName  = "/menu.Menu/DeleteMeal"
	Menu_FetchMeals_FullMethodName  = "/menu.Menu/FetchMeals"
)
...
func (c *menuClient) AddMeal(ctx context.Context, in *MealDetails, opts ...grpc.CallOption) (*ID, error) {
	...
	out := new(ID)
	err := c.cc.Invoke(ctx, Menu_AddMeal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuClient) GetMealByID(ctx context.Context, in *ID, opts ...grpc.CallOption) (*MealInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MealInfo)
	err := c.cc.Invoke(ctx, Menu_GetMealByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuClient) FetchMeals(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*Meals, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Meals)
	err := c.cc.Invoke(ctx, Menu_FetchMeals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Menu_AddMeal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Menu_AddMeal_FullMethodName,
	}
...
func _Menu_GetMealByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Menu_GetMealByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Menu_FetchMeals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Menu_FetchMeals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
